...
test('services: createCase 参数结构', function () {
  ...
  var dualCreateSource = fs.readFileSync(path.join(MP_DIR, 'pages', 'create-case', 'create-case.js'), 'utf8');
  assert(dualCreateSource.indexOf("mode: 'dual'") !== -1, '双人创建页必须明确传入 dual 模式');
